...
def convert_csv_to_json(csv_file_name, json_file_name):
    df = pd.read_excel(csv_file_name, usecols=['instruction', 'instruction_type', 'infographic_section', 'edit_type', 'target_element', 'target_location'])
    ...
    selected_columns = ['instruction', 'instruction_type', 'infographic_section', 'edit_type', 'target_element', 'target_location']
...
if __name__ == '__main__':
    json_file_name = 'DatasetFiles/instructions_new.json'
    csv_file_name = 'DatasetFiles/instructions_new.xlsm'
    # convert_csv_to_json(csv_file_name, json_file_name)
    convert_instructions_new_csv_to_json(csv_file_name, json_file_name)
